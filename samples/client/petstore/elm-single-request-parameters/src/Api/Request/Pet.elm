...
addPet : { pet : Api.Data.Pet } -> Api.Request Api.Data.Pet
addPet { pet_body } =
    Api.request
        "POST"
        "/pet"
...
deletePet : { petId : Int, apiKey : Maybe String } -> Api.Request ()
...
-}
findPetsByStatus : { status : List Status } -> Api.Request (List Api.Data.Pet)
...
-}
findPetsByTags : { tags : List String } -> Api.Request (List Api.Data.Pet)
...
-}
getPetById : { petId : Int } -> Api.Request Api.Data.Pet
...
updatePet : { pet : Api.Data.Pet } -> Api.Request Api.Data.Pet
updatePet { pet_body } =
    Api.request
        "PUT"
        "/pet"
...
updatePetWithForm : { petId : Int, name : Maybe String, status : Maybe String } -> Api.Request ()
...
uploadFile : { petId : Int, additionalMetadata : Maybe String, file : Maybe File } -> Api.Request Api.Data.ApiResponse
